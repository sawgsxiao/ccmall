...
public class AdvertApplication extends Controller {
	...
	public static Result advertAdd(){
		return ok(advertadd.render(""));
	}
	
	public static Result advertAddDo(){
...
//		File dir=new File("../apache-tomcat-8.0.30/webapps/images");
		...
		return ok(advertadd.render(result));
	...
	public static Result advertList() {
    	...
    	List<Advert> list = AdvertApplication.list(pageSize,pageNow,btn);
    	
    	//总数
		int countAll = AdvertApplication.count(btn);
