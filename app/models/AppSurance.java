...
@Entity
@Table(name="cc_app_surance")
public class AppSurance extends Model{
    ...
    @OneToMany(mappedBy="appSurance",cascade= CascadeType.ALL)
    private List<AppSuranceImage> images;

    public AppSurance() {

    }
    
    public static Finder<Integer,AppSurance> find = new Finder<Integer,AppSurance>(
    	Integer.class, AppSurance.class
  	); 
  	
  	public static AppSurance findById(int id) {
        return find.where().eq("id", id).findUnique();
    }
    
    public static List<AppSurance> findAllList() {
	...
	public List<AppSuranceImage> getImages() {
		return images;
	}

	public void setImages(List<AppSuranceImage> images) {
		this.images = images;
	}
